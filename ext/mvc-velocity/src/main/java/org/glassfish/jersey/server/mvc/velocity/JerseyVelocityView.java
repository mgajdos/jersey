...
public class JerseyVelocityView extends VelocityView {
     ...
     */
    // TODO raise a JIRA for this to be added to VelocityTools as there is currently no method to initialise VE with an
    // TODO ExtendedProperties - we could then retire JerseyVelocityView
    @Override
